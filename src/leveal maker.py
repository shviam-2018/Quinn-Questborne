...
blob_img = pygame.image.load('res/blob.png')
platform_x_img = pygame.image.load('res/platform_x.png')
platform_y_img = pygame.image.load('res/platform_y.png')
lava_img = pygame.image.load('res/lava.png')
coin_img = pygame.image.load('res/coin.png')
exit_img = pygame.image.load('res/exit.png')
save_img = pygame.image.load('res/save_btn.png')
load_img = pygame.image.load('res/load_btn.png')
